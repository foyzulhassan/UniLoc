...
public class Gradlebuildfixdata implements java.io.Serializable {
	...
	private Integer evBaselinebluirPos;
	private Double evBaselinebluirMrr;
	private Double evBaselinebluirMap;
	private Double evBaselinebluirNdcg;
	...
	public Integer getEvBaselineBluiRPos() {
		return evBaselinebluirPos;
	}

	public void setEvBaselineBluiRPos(Integer evBaselineISSTAPos) {
		this.evBaselinebluirPos = evBaselineISSTAPos;
	}

	public Double getEvBaselineBluiRMrr() {
		return evBaselinebluirMrr;
	}

	public void setEvBaselineBluiRMrr(Double evBaselineISSTAMrr) {
		this.evBaselinebluirMrr = evBaselineISSTAMrr;
	}

	public Double getEvBaselineBluiRMap() {
		return evBaselinebluirMap;
	}

	public void setEvBaselineBluiRMap(Double evBaselineISSTAMap) {
		this.evBaselinebluirMap = evBaselineISSTAMap;
	}

	public Double getEvBaselineBluiRNdcg() {
		return evBaselinebluirNdcg;
	}

	public void setEvBaselineBluiRNdcg(Double evBaselineISSTANdcg) {
		this.evBaselinebluirNdcg = evBaselineISSTANdcg;
	}
